    ...
    universes: [
      {
        ...
        scene: {
          ...
          paragraphs: [
            ...
            "천마는 폐허 위에 서서 자신의 과거를 되돌아봤다. 정파의 위선과 배신, 그리고 자신이 마교를 이끌었던 그 시절의 영광을.",
            "하지만 정사(正史)는 그를 악인으로 기록했다. 마교의 수장, 천하를 어지럽힌 자, 정파에 의해 처형당한 자.",
            "천마는 손을 뻗었다. 폐허 위에 떨어진 검을 집어들었다. 그 검은 여전히 뜨거웠다. 마지막 전투의 열기가 아직 식지 않았다.",
            '"정사(正史)를 뒤엎고 천마의 시대를 여시겠습니까?"',
            "천마는 검을 하늘로 향했다. 그리고 맹세했다. '이번 생에는, 정사(正史)를 뒤엎고 진실을 세상에 알리겠다.'",
          ],
        },
      },
      {
        ...
        scene: {
          ...
          paragraphs: [
            ...
            "그는 검을 하늘로 향했다. 그리고 맹세했다. '정파의 위선을 모두 벗겨내고, 진실을 세상에 알리겠다. 이번에는 반드시.'",
          ],
        },
      },
    ],
    ...
    universes: [
      {
        ...
        scene: {
          ...
          paragraphs: [
            ...
            "AI 이사님은 항상 옳았다. 그의 예측은 99.9%의 정확도를 자랑했다. 하지만 나는 그 0.1%의 가능성을 믿고 싶었다.",
            "회의실에서 AI 이사님을 마주했다. 그는 차갑고 완벽했다. 모든 것을 알고 있었고, 모든 것을 예측할 수 있었다.",
            "하지만 나는 그에게 질문했다. '만약 제가 예측을 벗어나는 선택을 한다면요?'",
            "AI 이사님은 미소를 지었다. '그것도 데이터에 포함되어 있습니다. 당신의 모든 가능성, 모든 선택지가 이미 계산되어 있습니다.'",
            '"AI 이사님의 완벽한 데이터에 변수를 입력하세요."',
            "나는 그에게 다가갔다. 그리고 말했다. '그렇다면, 당신이 예측하지 못한 선택을 해보겠습니다.'",
          ],
        },
      },
      {
        ...
        scene: {
          ...
          paragraphs: [
            ...
            "그리고 나는 그에게 다가갔다. 그리고 키스를 했다. 그것은 데이터에 없는 선택이었다.",
          ],
        },
      },
    ],
                    ...
                    >
                      ...
                      {story.comments && (
                        <div 
                          ...
                          className="mt-4 pt-6 border-t border-white/10 relative bg-gray-900 rounded-t-2xl -mx-5 sm:-mx-6 px-5 sm:px-6 pb-6"
                          style={{ 
                            zIndex: 50,
                          }}
                        >
